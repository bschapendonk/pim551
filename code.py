...
keybow.hardware._display._pixels.brightness = 0.1
...
layer_1 =     {4: [Keycode.CONTROL, Keycode.SHIFT, Keycode.M], # Teams toggle mute audio
               5: [Keycode.CONTROL, Keycode.SHIFT, Keycode.O], # Teams toggle mute video
               7: [Keycode.CONTROL, Keycode.SHIFT, Keycode.K], # Teams toggle hands
               8: [Keycode.CONTROL, Keycode.SHIFT, Keycode.SPACE],  # Slack toggle mute huddle
               12: [Keycode.M], # Slack toggle mute audio
               13: [Keycode.V]} # Slack toggle mute video
